...
# Instatiate 6 Movie objects with the names, poster URLs and trailer URLs 
...
movies = [cars_2, inside_out, good_dinosaur, monsters_uni, toy_story_3, brave]
